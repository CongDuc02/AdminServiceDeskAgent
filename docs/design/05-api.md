...
| `SYNC_GRAPH` | Chạy `intake_graph` trong luồng request, có gọi LLM (ADR-005). Response là stream lượt chat | Có — đây là tín hiệu đảo ngược của ADR-005 |
